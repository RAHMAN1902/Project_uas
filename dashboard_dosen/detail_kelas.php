...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="bg-white shadow-lg rounded-lg w-full max-w-4xl p-6">
        ...
        <table class="table-auto w-full text-center border-collapse border border-gray-300">
            ...
            <tbody id="tableBody">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr>";
                    echo "<td colspan='2' class='border border-gray-300 p-4 text-gray-500'>Tidak ada data mahasiswa</td>";
                    echo "</tr>";
                }
        ...
        <div class="text-center mt-6">
            <a href="kelas.php" class="bg-grey-500 hover:underline">Kembali ke Daftar Kelas</a>
        </div>
    </div>
</body>
