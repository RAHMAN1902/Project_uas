            ...
            <form action="" method="POST" class="bg-white shadow rounded p-6 space-y-4">
                <div>
                    ...
                    <input type="text" name="name"
                        class=" border w-full border-gray-300 rounded p-2 focus:outline-none focus:ring-2 focus:ring-sky-950"
                        required>
                </div>
                <div>
                ...
                <button type="submit" class="bg-sky-950 text-white px-4 py-2 rounded">Simpan</button>
            </form>
        </div>
    </div>
</body>
