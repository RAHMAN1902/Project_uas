...
<body class="bg-gray-100">
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-6">
            <h2 class="text-3xl font-bold mb-6 text-sky-950">Dashboard Admin</h2>
            ...
            <div class="bg-white shadow rounded p-6">
                <h3 class="text-lg font-semibold mb-4 text-gray-700">Perkembangan Pembelajaran (1 Tahun)</h3>
    ...
    function confirmLogout() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = '../auth/login_admin.php';
            }
        });
    }
    </script>
