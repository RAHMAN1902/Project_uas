...
if (isset($_POST['login'])) {
    ...
    if ($result->num_rows === 1) {
        ...
        if (password_verify($password, $user['password'])) {
            $_SESSION['user'] = $user;
            header("Location: ../dashboard_dosen/index.php");
            exit();
        };
...
<body class="bg-gray-100">
    <div class="relative h-screen bg-cover bg-center" style="background-image: url('../images/sch.png');">
        ...
        <div class="relative z-10 flex items-center justify-center h-full flex-col">
            ...
            <div class="text-white text-center mb-8">
                <h1 class="text-4xl font-bold">Selamat datang di PresensiNow</h1>
            </div>

            <!-- Tombol "Login sebagai Admin" di kanan atas -->
            <div class="absolute top-4 right-4">
                <a href="login_admin.php" class="bg-red-500 text-white py-2 px-4 rounded-lg text-sm">Login sebagai Admin</a>
            </div>
            ...
            <div class="w-full max-w-md mx-auto mt-10 bg-white bg-opacity-60 backdrop-blur-sm p-8 rounded-lg shadow-lg">
                ...
                <form method="POST">
                    <div class="mb-6">
                        ...
                        <input type="text" id="email" name="email" class="w-full px-4 py-3 border rounded-lg" required>
                    </div>
                    <div class="mb-6">
